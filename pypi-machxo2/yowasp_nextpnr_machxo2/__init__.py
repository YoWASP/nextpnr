...
def run_nextpnr_machxo2(argv):
    return yowasp_runtime.run_wasm(__package__, "nextpnr-machxo2.wasm", resources=["share"],
        argv=["yowasp-nextpnr-machxo2", *argv])


def _run_nextpnr_machxo2_argv():
    sys.exit(run_nextpnr_machxo2(sys.argv[1:]))
